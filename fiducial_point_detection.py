...
def find_fiducial_points(signal,fs,gr_r,gr2,gr3,gr4,gr5,gr6,gr7,gr8,gr9,gr10):
    fiducial_point=dict()
    # Encontrar R 
    locs_Rav = find_R(signal, height=gr_r, distance=0.3*fs)
    # Encontrar S
